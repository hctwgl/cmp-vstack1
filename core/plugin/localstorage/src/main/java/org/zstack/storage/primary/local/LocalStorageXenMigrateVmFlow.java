...
import org.zstack.storage.primary.local.LocalStorageXenBackend.*;
...
public class LocalStorageXenMigrateVmFlow extends NoRollbackFlow {
    private static final CLogger logger = Utils.getLogger(LocalStorageXenMigrateVmFlow.class);
    ...
    public static class VerifySnapshotChainCmd extends LocalStorageXenBackend.AgentCommand {
        public List<SnapshotTO> snapshots;
    }

    public static class RebaseSnapshotBackingFilesCmd extends LocalStorageXenBackend.AgentCommand {
        public List<SnapshotTO> snapshots;
    }

    @ApiTimeout(apiClasses = {APILocalStorageMigrateVolumeMsg.class})
    public static class CopyBitsFromRemoteCmd extends LocalStorageXenBackend.AgentCommand {
    ...
    public void run(final FlowTrigger next, Map data) {
        ...
        chain.then(new ShareFlow() {
...

            {
                ...
                dstHost = dbf.findByUuid(dstHostUuid, XenHostVO.class);
            }
        ...
        bus.send(msg, new CloudBusCallBack(completion) {
            ...
            public void run(MessageReply reply) {
                ...
                if (rsp.getTotalCapacity() != null && rsp.getAvailableCapacity() != null) {
                    new LocalStorageCapacityUpdater().updatePhysicalCapacityByXenAgentResponse(psUuid, hostUuid, rsp);
                }
    ...
    private List<Flow> createFlowsForSnapshot(List<VolumeInventory> volumesOnLocalStorage,
        ...
        for (final VSPair p : volumeHasSnapshots) {
            ...
            flows.add(new Flow() {
                ...
                XenHostVO dstHost = dbf.findByUuid(dstHostUuid, XenHostVO.class);
