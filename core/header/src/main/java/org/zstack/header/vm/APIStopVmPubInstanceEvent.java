 ...
 *@apiResult
 *
 * api event for message :ref:`APIStopVmInstanceMsg`
 *
 *@since 0.1.0
 *
 *@example
 ...
 */
public class APIStopVmPubInstanceEvent extends APIEvent {
    /**
     * @desc see :ref:`VmInstanceInventory`
     */
    private VmInstanceInventory inventory;
    
    public APIStopVmPubInstanceEvent() {
        super(null);
    }
    public APIStopVmPubInstanceEvent(String apiId) {
        super(apiId);
    }
