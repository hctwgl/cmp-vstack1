...
from aliyunagent.plugins import securitygroup_plugin
...
class TestSecurityGroupPlugin(object):
    ...
    def test_apply_rules(self):
        url = aliyunagent._build_url_for_test([securitygroup_plugin.SecurityGroupPlugin.SECURITY_GROUP_APPLY_RULE_PATH])
