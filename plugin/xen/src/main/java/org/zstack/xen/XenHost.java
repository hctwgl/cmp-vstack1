                ...
                public void setup() {
                    ...
                    flow(new NoRollbackFlow() {
                        ...
                        public void run(final FlowTrigger trigger, Map data) {
                            ...
                            String srcPath = PathUtil.findFileOnClassPath(String.format("ansible/xen/%s", agentPackageName), true).getAbsolutePath();
                            String destPath = String.format("/var/lib/zstack/xen/package/%s", agentPackageName);
                            ...
                            checker.addSrcDestPair(SshFileMd5Checker.ZSTACKLIB_SRC_PATH, String.format("/var/lib/zstack/xen/package/%s", AnsibleGlobalProperty.ZSTACKLIB_PACKAGE_NAME));
