...
import org.zstack.xen.XenHostConnectExtensionPoint;
import org.zstack.xen.XenHostConnectedContext;
 ...
 */
public class LocalStorageXenFactory implements LocalStorageHypervisorFactory, XenHostConnectExtensionPoint,
        FailToAddHostExtensionPoint {
    private static final CLogger logger = Utils.getLogger(LocalStorageXenFactory.class);
