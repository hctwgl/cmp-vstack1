...
CREATE TABLE  `zstack`.`PubVmInstanceEO` (
    ...
    `pubAccountUuid` varchar(255) NOT NULL COMMENT 'password',
    ...
    `cloudType` varchar(2048) NOT NULL COMMENT 'host description',
...
# Foreign keys for table XenHostVO

ALTER TABLE XenHostVO ADD CONSTRAINT fkXenHostVOHostEO FOREIGN KEY (uuid) REFERENCES HostEO (uuid) ON UPDATE RESTRICT ON DELETE CASCADE;
